// リアルに近いモックデータ（APIキー取得後に実APIに差し替え）
...
const financialsMap: Record<string, typeof TOYOTA_FINANCIALS> = {
  E02144: TOYOTA_FINANCIALS,
  E02000: SONY_FINANCIALS,
  E04577: NTT_FINANCIALS,
  E02275: NINTENDO_FINANCIALS,
};
...
function defaultFinancials(code: string) {
  ...
  return base.map((v, i) => ({
    period: `${2021 + i}年3月期`,
    fiscalYear: `FY${2021 + i}`,
    netSales: v,
    operatingIncome: Math.round(v * 0.1),
    ordinaryIncome: Math.round(v * 0.105),
    netIncome: Math.round(v * 0.07),
    totalAssets: Math.round(v * 4),
    equity: Math.round(v * 2),
    eps: 320 + i * 15,
    roe: 7 + i * 0.5,
    operatingMargin: 10 + i * 0.2,
  }));
}
...
export function getMockCompanyDetail(code: string): CompanyDetail | null {
  ...
  const recentFilings: Filing[] = [
    { docID: `S100${code.slice(-4)}01`, edinetCode: code, filerName: company.filerName, docType: 2, docTypeLabel: "有価証券報告書", periodStart: "2024-04-01", periodEnd: "2025-03-31", submitDateTime: "2025-06-25T09:00:00", docDescription: `有価証券報告書－第${100 + parseInt(code.slice(-2))}期` },
    { docID: `S100${code.slice(-4)}02`, edinetCode: code, filerName: company.filerName, docType: 4, docTypeLabel: "四半期報告書", periodStart: "2025-04-01", periodEnd: "2025-06-30", submitDateTime: "2025-08-10T09:00:00", docDescription: `第${100 + parseInt(code.slice(-2))}期第1四半期報告書` },
  ];
...
export const MOCK_BULK_REPORTS: BulkReport[] = [
  { docID: "B10001", reporterName: "ブラックロック・ジャパン株式会社",         targetCompany: "トヨタ自動車株式会社",       targetCode: "7203", holdingRate: 6.82, holdingShares: 945_230, submitDateTime: "2025-06-27T15:00:00", changeType: "増加", previousRate: 6.21 },
  { docID: "B10002", reporterName: "バンガード・グループ",                    targetCompany: "ソニーグループ株式会社",     targetCode: "6758", holdingRate: 8.14, holdingShares: 102_600, submitDateTime: "2025-06-26T15:00:00", changeType: "新規" },
  { docID: "B10003", reporterName: "フィデリティ投信株式会社",                targetCompany: "任天堂株式会社",           targetCode: "7974", holdingRate: 5.23, holdingShares: 70_100,  submitDateTime: "2025-06-25T15:00:00", changeType: "減少", previousRate: 5.89 },
  { docID: "B10004", reporterName: "ノルウェー政府年金基金グローバル",         targetCompany: "キーエンス株式会社",       targetCode: "6861", holdingRate: 3.45, holdingShares: 92_400,  submitDateTime: "2025-06-24T15:00:00", changeType: "増加", previousRate: 3.10 },
  { docID: "B10005", reporterName: "三井住友DSアセットマネジメント株式会社",   targetCompany: "日立製作所",              targetCode: "6501", holdingRate: 5.67, holdingShares: 560_000, submitDateTime: "2025-06-23T15:00:00", changeType: "変更", previousRate: 5.60 },
  { docID: "B10006", reporterName: "マッキンゼー・ファンド",                  targetCompany: "NTTデータグループ株式会社", targetCode: "9613", holdingRate: 7.30, holdingShares: 210_000, submitDateTime: "2025-06-22T15:00:00", changeType: "新規" },
  { docID: "B10007", reporterName: "JPモルガン・アセット・マネジメント",       targetCompany: "リクルートホールディングス", targetCode: "6098", holdingRate: 4.88, holdingShares: 81_200,  submitDateTime: "2025-06-20T15:00:00", changeType: "減少", previousRate: 5.12 },
  { docID: "B10008", reporterName: "アセットマネジメントOne株式会社",          targetCompany: "ソフトバンクグループ株式会社", targetCode: "9984", holdingRate: 9.41, holdingShares: 1_120_000, submitDateTime: "2025-06-19T15:00:00", changeType: "増加", previousRate: 9.10 },
];

export const MOCK_STATS: DashboardStats = {
  totalFilings: 248,
  annualReports: 42,
  quarterlyReports: 156,
  bulkReports: 50,
  date: "2025-06-27",
};
