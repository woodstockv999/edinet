...
import { getDashboardStats, getFilings, getBulkReports, searchCompanies, isDemoMode } from "@/lib/edinet";
      ...
      <div className="flex items-start justify-between gap-2">
        ...
        <div className="text-right shrink-0">
          <p className={`text-sm font-bold tabular-nums ${changeColor}`}>
            {arrow} {report.holdingRate != null ? `${report.holdingRate.toFixed(2)}%` : "詳細不明"}
          </p>
          {report.previousRate && (
